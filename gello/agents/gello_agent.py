...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTA2W840-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            2*np.pi/2, 
            2*np.pi/2, 
        ...
        joint_signs=(1, 1, -1, 1, 1, 1),
        gripper_config=(7, 192, 150),
    ),
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAK8CN6-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            4 * np.pi / 2,
            3 * np.pi / 2,
